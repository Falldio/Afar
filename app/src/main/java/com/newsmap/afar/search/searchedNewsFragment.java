...
public class searchedNewsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_searched_news_list, container, false);
        ...
        if (view instanceof RecyclerView) {
            ...
            recyclerView.setAdapter(new searchedNewsRecyclerViewAdapter(searchedNews.ITEMS, mListener));
        }
        return view;
    }
